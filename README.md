## perception_open3d (jazzy) - 0.1.2-1

The packages in the `perception_open3d` repository were released into the `jazzy` distro by running `/usr/local/google/home/marcogg/migration/bin/bloom-release perception_open3d --rosdistro jazzy` on `Mon, 22 Apr 2024 11:05:30 -0000`
